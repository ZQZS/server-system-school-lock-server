...
module.exports = selectTimeFindPlace = async function (req, res, next) {
  ...
  const selectUserInfoPage = `UPDATE user SET user_name = ?, user_phone = ? WHERE user_no = ?`;
  const selectUserPasswordInfoPage = `UPDATE user SET user_name = ?, user_phone = ?, user_password = ? WHERE user_no = ?`;
